            ...
            IconButton(
              ...
              onPressed: () {
                ...
                ref.read(aiChatProvider.notifier).resetChat(
                      buildUserContext(
                        dailySpent: ref.read(dailyTotalProvider).valueOrNull ?? 0.0,
                        dailyBudget: ref.read(userPreferencesNotifierProvider)?.dailyLimit ?? 0.0,
                        weeklySpent: ref.read(weeklyTotalProvider).valueOrNull ?? 0.0,
                        weeklyBudget: ref.read(userPreferencesNotifierProvider)?.weeklyLimit,
                        monthlySpent: ref.read(monthlyTotalProvider).valueOrNull ?? 0.0,
                        monthlyBudget: ref.read(userPreferencesNotifierProvider)?.monthlyLimit,
                        currency: ref.read(userPreferencesNotifierProvider)?.preferredCurrency ?? 'USD',
                        firstName: ref.read(userPreferencesNotifierProvider)?.firstName ?? '',
                        recentExpenses: ref.read(recentExpensesProvider).valueOrNull ?? [],
  ...
  Widget build(BuildContext context, WidgetRef ref) {
    ...
    return InkWell(
      ...
      child: Container(
        ...
        child: Text(
          label,
          style: AppTextStyles.labelMedium(color: primary),
        ),
      ),
    );
  }
